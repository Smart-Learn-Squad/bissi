"""Bissi Smartlearn — Educational Edition.
Launches the WebEngine UI with pedagogical branding and prompts.
"""
...
from configs.prompts import SMARTLEARN_PROMPT
from agent import BissiAgent

def main():
    app = QApplication(sys.argv)
    app.setApplicationName("Bissi Smartlearn")
    app.setStyle("Fusion")
    ...
    base_dir = Path("~/.bissi/smartlearn").expanduser()
    ...
    win.setWindowTitle("Bissi Smartlearn")
    win.show()
    sys.exit(app.exec())
