...
class EmailClient:
    ...
    def __init__(self,
        ...
        Args:
            ...
            password: Email password (optional, will check env or keyring)
        ...
        # Security: check password priority (argument > env > keyring)
        if password:
            self.password = password
        elif os.environ.get("BISSI_EMAIL_PASSWORD"):
            self.password = os.environ.get("BISSI_EMAIL_PASSWORD")
        else:
            self.password = keyring.get_password("bissi_email", username)
        
        if not self.password:
            raise ValueError(f"Password required for {username}. Use BISSI_EMAIL_PASSWORD env var or keyring.")
...
def create_client(provider: str, username: str, password: Optional[str] = None) -> EmailClient:
