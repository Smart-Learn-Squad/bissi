...
def image_to_text(image_path: Union[str, Path], 
    ...
    """
    validate_path_safety(image_path)
...
def pdf_to_text(file_path: Union[str, Path],
    ...
    try:
        # pdf2image doesn't have a direct timeout, but we can wrap it if needed.
        # However, for now, let's assume images conversion is relatively safe or we'd need a threading wrapper.
